...
printf("enter the number of elements of polynomial1\n");
scanf("%d",&n1);
printf("enter the number of elements of polynomial2\n");
scanf("%d",&n2);
printf("enter the elements of polynomial1 in decending order\n");
for(i=0;i<n1;i++)
{
